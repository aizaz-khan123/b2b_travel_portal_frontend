            ...
            <Card className="mt-5 bg-base-100">
                <CardBody className={"p-0"}>
                    <div className="flex items-center justify-between px-5 pt-5">
                        ...
                        <div className="inline-flex items-center gap-3">
                            <Link href={routes.apps.settings.airport_create} aria-label={"Create product link"}>
                    ...
                    <div className="overflow-auto">
                        <Table className="mt-2 rounded-box">
                            <TableHead>
                                ...
                                <span className="text-sm font-medium text-base-content/80">Airport Name</span>
                                <span className="text-sm font-medium text-base-content/80">ISO Country</span>
                                <span className="text-sm font-medium text-base-content/80">IATA Code</span>
                                <span className="text-sm font-medium text-base-content/80">Municipality</span>
